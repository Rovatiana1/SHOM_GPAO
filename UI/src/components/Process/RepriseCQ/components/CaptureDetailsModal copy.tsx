                                    ...
                                    <div key={index} className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                        ...
                                        {capture.isNew ? (
                                            ...
                                            <button
                                                ...
                                                className="ml-4 p-2 text-gray-500 hover:bg-gray-100 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                title={capture.isArchived ? "Cette capture est archivée" : "Archiver cette capture"}
                                            >
                                                {capture.isArchived ? (
                                                    <span className="text-xs font-bold px-2">Archivée</span>
                                                ) : (
                                                    <Icons.Archive />
                                                )}
                                            </button>
