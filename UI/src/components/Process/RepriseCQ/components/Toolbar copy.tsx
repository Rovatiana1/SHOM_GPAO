...
import { DateInfo, DisplayMode, Metadata, Point, Capture } from '../../../../types/Image';
            ...
            {hasData && (
                <>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4">
                        ...
                        <button onClick={onExport} className="bg-green-600 text-white py-2 px-3 rounded-md hover:bg-green-700 flex items-center justify-center gap-2">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                        ...
                        <div className="space-y-2">
                            <button onClick={onStartCapture} className="w-full bg-teal-500 text-white py-2 px-3 rounded-md hover:bg-teal-600 flex items-center justify-center gap-2">
                                <Icons.Camera /> Nouvelle Capture
                            </button>
                            <button
                                onClick={onViewCaptures}
                                disabled={captureCount === 0}
                                className="w-full mt-2 relative bg-blue-500 text-white py-2 px-3 rounded-md hover:bg-blue-600 flex items-center justify-center gap-2 disabled:bg-gray-300 disabled:cursor-not-allowed"
                            >
                            ...
                            {/* FIX: The 'captures' variable was not defined. It has been added as a prop to resolve the reference error. */}
                            <button
                                onClick={onExportCaptures}
                                disabled={captureCount === 0 || captures.filter(c => c.isNew).length === 0}
                            ...
                            >
                                {isExportingCaptures ? (
                                    ...
                                    <>
                                        <Icons.Download /> Exporter Captures
                                    </>
                                )}
                            </button>
                        </div>
