                ...
                <>
                    ...
                    <div className="mt-4 border-t border-gray-200 py-2">
                        <p className="text-xs text-gray-500 text-center px-2">
                            Astuce : maintenez <kbd className="px-2 py-1 text-xs font-semibold text-gray-800 bg-gray-100 rounded-md border">Shift</kbd> et glissez pour sélectionner plusieurs points d'une même date.
                        </p>
                    </div>
