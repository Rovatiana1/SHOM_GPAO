...
import { pauseCurrentLot, resumeCurrentLot } from '../../../store/slices/processSlice';
          ...
          {currentLot && (
             <div className="flex items-center gap-2">              
                ...
                <button
                  ...
                  className={`relative inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors disabled:bg-gray-400 ${
                    isProcessing
