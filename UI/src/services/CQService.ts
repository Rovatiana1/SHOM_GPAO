...
// export async function savePoints(points: any[], dates: string[], metadata: any, duration: number, export_path: string) {
...
//   const payload = { points, dates, metadata: metadataWithTuple, duration, export_path };
